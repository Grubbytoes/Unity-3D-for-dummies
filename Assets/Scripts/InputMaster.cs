...
public partial class @PlayerMovement: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""CamControl"",
                    ""type"": ""Value"",
                    ""id"": ""ecb634f1-310b-44ba-8d34-79ef10a779fc"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""0ee93482-2ac7-4710-afe1-fce50f080846"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""fc0437ca-8582-4926-9b80-f5192d029815"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""590796d9-407c-41a6-ae3d-7953c3f6b930"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""77ecf8e5-2a8d-4908-a66b-7adaffb30110"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""ab11d854-d20e-458d-b835-69242d3af283"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_All_HorizontalMovement = m_All.FindAction("HorizontalMovement", throwIfNotFound: true);
        m_All_Jump = m_All.FindAction("Jump", throwIfNotFound: true);
        m_All_CamControl = m_All.FindAction("CamControl", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_All_HorizontalMovement;
    private readonly InputAction m_All_Jump;
    private readonly InputAction m_All_CamControl;
    public struct AllActions
    {
        private @PlayerMovement m_Wrapper;
        public AllActions(@PlayerMovement wrapper) { m_Wrapper = wrapper; }
        public InputAction @HorizontalMovement => m_Wrapper.m_All_HorizontalMovement;
        public InputAction @Jump => m_Wrapper.m_All_Jump;
        public InputAction @CamControl => m_Wrapper.m_All_CamControl;
